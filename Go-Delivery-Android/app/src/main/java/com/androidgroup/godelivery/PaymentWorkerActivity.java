...
public class PaymentWorkerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentTitle = (TextView) findViewById(R.id.PaymentJobSeekerTitleID);
        paymentDescription = (TextView) findViewById(R.id.PaymentJobSeekerDescriptionID);
    ...
    private class RemoveJobListing extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("OK"))
            {
                Intent intent = new Intent(PaymentWorkerActivity.this, DeciderActivity.class);
